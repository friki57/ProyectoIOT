    ...
    render() {
        return (
            <View style={stylesLoginScreen.container}>
                ...
                <Text style={stylesLoginScreen.text}> {Constans.REGBAU}</Text>
                    <TextInputLogin
